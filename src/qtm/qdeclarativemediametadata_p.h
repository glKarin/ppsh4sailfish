...
#define QtMultimediaKit QMediaMetaData
#else
...
#ifdef _KARIN_MM_EXTENSIONS
        return m_control->metaData(QtMultimediaKit::RatingOrganization);  // orig is RatingOrgani[s]ation, what is
#else
